          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-white/70 mb-6">
                At Western Intercontinental Bank, we believe financial
                institutions play a vital role in creating a more sustainable
                future. Our comprehensive sustainability strategy focuses on
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-600 mb-8">
                  Western Intercontinental Bank operates in over 100 countries,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-12">
              Join Western Intercontinental Bank today and experience banking
              reimagined for the digital age. Opening an account takes less than
              10 minutes.
            </p>
